...
public class DynamicTopicConsumerCS extends Thread  {
    ...
    public DynamicTopicConsumerCS(String topic_received , String kafka_servers_received , io.vertx.mutiny.mysqlclient.MySQLPool client_received)  
    {
...
*/
                      ...
                      String shop_name = obj.getJSONObject("Purchase_Event").getString("Shop"); // TODO: FIX THIS
                      String loyaltyCard_id = obj.getJSONObject("Purchase_Event").getString("LoyaltyCard_ID");
                      // loyaltyCard_id, shop_name 

                      String query = "INSERT INTO LDiscountCoupon (shopname,loyaltycardid) VALUES ("
                      // + "'" + timestamp + "',"
                      // + "'" + price + "',"
                      // + "'" + product + "',"
                      // + "'" + supplier + "',"
