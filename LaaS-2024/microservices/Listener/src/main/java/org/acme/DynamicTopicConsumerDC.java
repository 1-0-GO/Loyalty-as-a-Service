...
public class DynamicTopicConsumerDC extends Thread  {
    ...
    public DynamicTopicConsumerDC(String topic_received , String kafka_servers_received , io.vertx.mutiny.mysqlclient.MySQLPool client_received)  
    {
...
*/
                      ...
                      String discount = obj.getJSONObject("Purchase_Event").getString("Discount");
                      String expiryDate = obj.getJSONObject("Purchase_Event").getString("ExpiryDate");
                    ...
                    // discount, expiryDate, loyaltyCard_id, shop_name 
